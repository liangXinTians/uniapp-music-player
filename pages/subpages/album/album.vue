		...
		<!-- <view class="nav-bar">
			...
			<view class="nav-bar-con">
				<view class="flex-box align">
					...
					<view class="title flex-item tac">
						歌单
					</view>
				</view>
			</view>
		</view> -->
		<!-- <navigation-bar title="页面标题" @leftclick="goBack" class="top-back"></navigation-bar> -->
		...
		<scroll-view scroll-y="true" class="page-content">
			<view class="album-top">
				...
				<view class="album-con">
					...
					<view class="flex-box">
						<view class="img-info">
							<image class="img" :src="album.coverImgUrl" mode="widthFix"></image>
							<view class="count">
								344.5
							</view>
						</view>
						<view class="info-con flex-item">
							...
							<view class="avator-box flex-box">
								<image v-if="album.creator" class="avator" :src="album.creator.avatarUrl"
									mode="widthFix"></image>
								<text v-if="album.creator">{{album.creator.nickname}}</text>
								<view class="iconfont">
									&#xe605;
								</view>
							</view>
